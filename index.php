...
<header class="container header-container">
    <div class="container container-space">
        <div class="container">
            <a href="<?php echo get_root_url() . DIRECTORY_SEPARATOR . 'index.php'; ?>" class="logo-title"><strong>Kaňka & Danišovič</strong></a>
        </div>
        <div class="container">
    ...
    <nav id="navigation" class="container navigation-container">
        <div class="container nav-item">
            <a href="<?php echo get_root_url() . DIRECTORY_SEPARATOR . 'experiments.php?init=carShockAbsorber' ?>"><?php echo $language['HEADER_SUB_MENU']["carShockAbsorber"]; ?></a>
    ...
    <div class="container container-space content-container container-title">
      <div class="container content-title">
        <h1><?php echo $language['OCTAVE_API_PAGE_TITLE']; ?></h1>
          <p>KEY: 51b1144a-b7a2-47c1-a6c5-f15330213465</p>
      </div>
    </div>
