<?php
  // MENU
  $language['HEADER_MENU_1'] = 'Domov';
  $language['HEADER_MENU_2'] = 'Experimenty';
  ...
  $language['OCTAVE_API_RESPONSE_BODY'] = 'Telo odpovede';
  $language['OCTAVE_API_EXPORT_SUBTITLE'] = 'Export záznamov';
  $language['OCTAVE_API_LOG'] = 'Záznam';
